...
export default function About() {
  const stats = [
    { icon: <FaHome className="w-6 h-6" />, number: "10,000+", label: "Properties Listed" },
    { icon: <FaUsers className="w-6 h-6" />, number: "25,000+", label: "Happy Users" },
    { icon: <FaHandshake className="w-6 h-6" />, number: "15,000+", label: "Successful Rentals" },
    { icon: <FaShieldAlt className="w-6 h-6" />, number: "99.9%", label: "Secure Transactions" }
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="bg-gradient-to-br from-teal-600 via-teal-500 to-teal-400 text-white py-12">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">About RentDirect</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
              <div className="flex items-center mb-3">
                <FaGlobe className="w-6 h-6 text-blue-600 mr-3" />
      ...
      <section className="py-12 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Our Core Values</h2>
      ...
      <section className="py-12 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
            <div className="text-center mb-6">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-full mb-3">
                <FaChartLine className="w-6 h-6 text-gray-600 dark:text-gray-300" />
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-gray-600 dark:text-gray-300 mb-1">5%</div>
                <div className="text-sm text-gray-700 dark:text-gray-300">Platform Fee</div>
              </div>
              <div className="text-center p-3 bg-green-50 dark:bg-green-900/30 rounded-lg">
                <div className="text-2xl font-bold text-green-600 mb-1">95%</div>
                <div className="text-sm text-gray-700 dark:text-gray-300">Landlord Receives</div>
              </div>
              <div className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-gray-600 dark:text-gray-300 mb-1">0%</div>
                <div className="text-sm text-gray-700 dark:text-gray-300">Additional Fees</div>
              </div>
            </div>
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Built by Nigerians, for Nigerians</h2>
